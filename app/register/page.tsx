...
const Register = () => {
  ...
  const validate = () => {
    ...
    if (formData.teamManager === null) newErrors.teamManager = "Team manager selection is required.";
    ...
    if (formData.teamManager && !formData.idcard) newErrors.idcard = "ID card is required for team managers.";
    if (!formData.teamManager) {
      ...
      if (!formData.admission1) newErrors.admission1 = "Admission1 is required.";
      if (!formData.admission2) newErrors.admission2 = "Admission2 is required.";
    }
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                required
                className={`w-full px-4 py-2 border ${errors.name ? "border-red-500" : "border-[#333333]"
            ...
            <div>
              <label className="block text-sm font-medium text-yellow-600 mb-2">
                USN<sup className="text-red-600 font-extrabold text-">*</sup>
              </label>
              <input
                type="text"
                name="usn"
                ...
                onChange={handleChange}
                required
                className={`w-full px-4 py-2 border ${errors.usn ? "border-red-500" : "border-[#333333]"
                  } rounded-lg text-sm bg-white-600 text-black focus:outline-none focus:border-yellow-500`}
              />
              {errors.usn && (
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                className={`w-full px-4 py-2 border ${errors.phone ? "border-red-500" : "border-[#333333]"
                  } rounded-lg text-sm bg-white-600 text-black focus:outline-none focus:border-yellow-500`}
              />
              {errors.phone && (
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-yellow-600 mb-2">
                Are you registering as Team Manager?<sup className="text-red-600 font-extrabold text-">*</sup>
              </label>
            ...
            <>
              ...
              <div className="mb-6">
                {Object.entries(groupedEvents).map(([category, events]) => (
                  <div key={category}>
                    <h2 className="text-xl font-semibold text-yellow-600 mb-2">{category}</h2>
          ...
          <fieldset className="border-2 mb-5 border-black p-4 rounded-lg hover:scale-105 transform transition-all">
            ...
            <div className="space-y-4">
              {formData.teamManager ? (
                <>
                  <div>
                    <label
                      ...
                      htmlFor="photo"
                    >
                      PHOTO:<sup className="text-red-600 font-extrabold text-">*</sup>
                    </label>
                    <input
                      type="file"
                      id="photo"
                  ...
                  <div>
                    <label
                      ...
                      htmlFor="idcard"
                    >
                      IDCARD:<sup className="text-red-600 font-extrabold text-">*</sup>
                    </label>
                    <input
                      type="file"
                      id="idcard"
                ...
                ["photo", "aadhar", "sslc", "puc", "idcard", "admission1", "admission2"].map((fileField) => (
                  <div key={fileField}>
                    <label
                      className="block text-sm font-small text-yellow-600 mb-1"
                      htmlFor={fileField}
                    >
                      {fileField.toUpperCase()}:<sup className="text-red-600 font-extrabold text-">*</sup>
                    </label>
                    <input
                      type="file"
                      id={fileField}
